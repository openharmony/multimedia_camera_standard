...
declare namespace camera {
  ...
  enum CameraFormat {
     ...
     * @since 8
     */
    CAMERA_FORMAT_AVC = 3000,

    /**
     * HEVC format.
     * @since 8
     */
    CAMERA_FORMAT_HEVC = 3001,
  }
  ...
  interface CameraInput {
    ...
    /**
     * Gets all supported sizes for current camera input and use case.
     * @return Supported size array.
     * @since 8
     */
    getSupportedPreviewSizes(callback: AsyncCallback<Array<Size>>): void;
    getSupportedPreviewSizes(): Promise<Array<Size>>;
    getSupportedPhotoSizes(callback: AsyncCallback<Array<Size>>): void;
    getSupportedPhotoSizes(): Promise<Array<Size>>;
    getSupportedVideoSizes(callback: AsyncCallback<Array<Size>>): void;
    getSupportedVideoSizes(): Promise<Array<Size>>;

    /**
     * Gets all supported formats for current camera input and use case.
    ...
    /**
     * Check if flash mode supported for current camera input.
    ...
    /**
     * Check if exposure mode supported for current camera input.
    ...
    /**
     * Check if focus mode supported for current camera input.
    ...
    /**
     * Gets supported zoom ratio range for current camera input.
     * @return zoon ratio range, min and max value.
     * @since 8
     */
