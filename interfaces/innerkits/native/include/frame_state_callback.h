...
public:
     ...
     */
    virtual void OnFrameFinished(const Camera &camera,
        const FrameConfig &frameConfig, const FrameResult &frameResult) {}
     ...
     * @param frameResult Indicates the capture results.
     */
    virtual void OnFrameError(const Camera &camera, const FrameConfig &frameConfig,
        int32_t errorCode, const FrameResult &frameResult) {}
};
} // namespace Media
} // namespace OHOS
