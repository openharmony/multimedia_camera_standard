...
public:
    ...
    std::vector<CODEC_HANDLETYPE> vencHdls_;
    std::vector<std::list<Surface *>> vencSurfaces_;
    std::vector<HalVideoProcessorAttr *> vencAttr_;
    int32_t VideoEncIsExist(const HalVideoProcessorAttr &attr);
